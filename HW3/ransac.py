...
def RANSAC(
    ...
    if best_num_inliers >= 8:
        # ============================================================
        # Re-estimate E from the inlier set,
        # then recover the final (R, t) via recover_pose()
        best_E = compute_E(img1_pts[best_inliers_mask], img2_pts[best_inliers_mask], K)
        best_R, best_t, best_3d = recover_pose(best_E, img1_pts[best_inliers_mask], img2_pts[best_inliers_mask], K)
        # ============================================================
    else:
    ...
    return best_R, best_t, best_inliers_mask, best_E, best_3d