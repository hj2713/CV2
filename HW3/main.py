...
class Config:
    ...
    # Image paths
    img1_path: str = "images/img11.jpeg"
    img2_path: str = "images/img12.jpeg"
    ...
    feature_matching_ratio_threshold: float = 0.8

    # Step 4 RANSAC
    ransac_s: int = 8  # Minimum 8 points for essential matrix
    ransac_epsilon = 2e-4
    ransac_num_iters: int = 2000
